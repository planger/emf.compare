 ...
 *     Philip Langer - [XXX] Adds support for three-way text merging 
 *******************************************************************************/
...
public class AttributeChangeMerger extends AbstractMerger {
	...
	/**
	 * Specifies whether the given {@code attribute} is an attribute of type EString.
	 * 
	 * @param attribute
	...
	private boolean isStringAttribute(EAttribute attribute) {
		return EcorePackage.eINSTANCE.getEString().equals(attribute.getEType());
	}
