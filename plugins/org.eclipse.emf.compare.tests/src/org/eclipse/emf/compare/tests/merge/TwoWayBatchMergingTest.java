...
public class TwoWayBatchMergingTest {
	...
	/**
	 * Tests a scenario in which multiple nodes are moved inside a feature map. This results in an incorrect
	 * ordering of the elements inside the map, after the merge.
	 * 
	 * @throws IOException
	 *             if {@link TwoWayMergeInputData} fails to load the test models.
	 */
